...
datasets = pd.read_csv('layers/student_id_predictor/Data Set/csv data/train.csv')
...
def load_and_preprocess_images(image_names, target_size=(img_rows, img_cols)):
    ...
    for img_name in image_names:
        img_path = 'layers/student_id_predictor/Data Set/train data/' + str(img_name)  
...
Y_train = to_categorical(train_data['class_name'], num_classes=10)
Y_test = to_categorical(test_data['class_name'], num_classes=10)
...
# Saving the Model
model.save('student_id_predictor.h5')
